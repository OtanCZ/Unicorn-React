...
function App() {
    return (
        <div className={"min-h-screen min-w-screen bg-emerald-900"}>
            <h1 className={"text-center text-6xl"}>Kuchařka</h1>
            <RecipeList recipes={mockRecipeData}/>
        </div>
    );
}
